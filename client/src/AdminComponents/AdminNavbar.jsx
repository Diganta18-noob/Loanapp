...
import { FiPlus, FiList, FiInbox, FiUser, FiLogOut, FiChevronDown, FiMenu, FiX } from 'react-icons/fi';
...
function AdminNavbar() {
    ...
    useEffect(() => {
        ...
        const handleOutside = (e) => {
            if (!e.target.closest('.admin-navbar') && !e.target.closest('.admin-mobile-menu')) {
                setMenuOpen(false);
            }
        };
    ...
    const navLinks = [
        ...
        { to: '/admin/loanRequests', icon: <FiInbox />, label: 'Requests' },
    ];
            ...
            <AnimatePresence>
                {menuOpen && (
                    ...
                    >
                        ...
                        <button className="admin-mobile-link admin-mobile-logout" onClick={() => { handleLogout(); setMenuOpen(false); }}>
                            <FiLogOut /> Sign Out
                        </button>
                    </motion.div>
                )}
